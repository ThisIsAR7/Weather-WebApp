...
async function checkWeather(city){
    const reaponse = await fetch(apiUrl + city +`&appid=${apiKey}`);
    if(reaponse.status == 404){
        ...
        document.querySelector(".wind").innerHTML = data.wind.speed + "/h";
        ...
        if(data.weather[0].main == "Clouds"){
            ...
            weatherIcon.src = "css/img/rain.webp";
        } else if(data.weather[0].main == "Drizzle"){
            weatherIcon.src = "css/img/drizzle.webp";
        } else if(data.weather[0].main == "Mist"){
            weatherIcon.src = "css/img/mist.webp";
        }
